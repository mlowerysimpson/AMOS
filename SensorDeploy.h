...
#define MAX_SD_PULSE_TIME 2500 //maximum pulse time in microseconds, corresponds to the maximum possible servo motor angle, and the fully deployed state of the sensor deployment arm (i.e. sensors should be in the water)
#define MIN_SD_PULSE_TIME 500 //mininum pulse time in microseconds, corresponds to the minimum possible servo motor angle, and the fully retracted state of the sensor deployment arm (i.e. sensors should be retracted out of the water onto the boat deck)
