...
#define MIN_WATER_RUDDER_ANGLE -45.0 //minimum allowed angle of water rudder in degrees
#define MAX_WATER_RUDDER_ANGLE 45.0 //maximum allowed angle of water rudder in degrees
